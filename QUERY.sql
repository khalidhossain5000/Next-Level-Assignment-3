...
SELECT booking_id,full_name,fixture,ROUND(total_cost) as total_cost FROM bookings as b
...
SELECT match_id,fixture,ROUND(base_ticket_price) as base_ticket_price FROM matches ORDER BY base_ticket_price DESC LIMIT 2 OFFSET 1
